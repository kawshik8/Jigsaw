...
#python3 src/main.py --model selfie --batch-size 128 --exp-name selfie-finetune-whole-linear --results-dir "./results" --data-dir "./data" --pretrain-total-iters 120000 --pretrain-val-interval 2000 --pretrain-learning-rate 1e-2 --transfer-paradigm "tunable" --load-ckpt "pretrain_cifar10_un_best.ckpt" --pretrain-tasks "none" --finetune-tasks cifar10_lp100,cifar10_lp10 --finetune-total-iters 120000 --finetune_learning_rate 1e-2 --finetune-val-interval 2000 

## STL 10
python3 src/main.py --model selfie --batch-size 128 --exp-name selfie-finetune-whole-linear  --num-patches 9 --pretrain-task "stl10_un" --results-dir "./results" --data-dir "./data" --pretrain-total-iters 120000 --pretrain-val-interval 2000 --pretrain-learning-rate 1e-2 --finetune-tasks stl10_fd0_res1,stl10_fd0_res2,stl10_fd0_res3,stl10_fd0_res4 --finetune-total-iters 120000 --finetune_learning_rate 1e-2 --finetune-val-interval 2000 
python3 src/main.py --model selfie --batch-size 128 --exp-name selfie-finetune-whole-linear --results-dir "./results" --data-dir "./data" --pretrain-total-iters 120000 --pretrain-val-interval 2000 --pretrain-learning-rate 1e-2 --transfer-paradigm "tunable" --load-ckpt "pretrain_stl10_un_complete.ckpt" --pretrain-tasks "none" --finetune-tasks stl10_fd0 --finetune-total-iters 120000 --finetune_learning_rate 1e-2 --finetune-val-interval 2000 
